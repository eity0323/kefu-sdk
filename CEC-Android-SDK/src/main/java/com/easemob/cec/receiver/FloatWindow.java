...
//                }
    ...
    private void setupSurfaceView() {
        ...
        CallSurfaceView mCurrentSurfaceView = (CallSurfaceView) floatView.findViewById(R.id.call_surfaceview);
...
//        oppositeView = new EMCallSurfaceView(context);
        ...
        int lw = dp2px(context, 96);
        int lh = dp2px(context, 128);
        int ow = dp2px(context, 96);
        int oh = dp2px(context, 128);
