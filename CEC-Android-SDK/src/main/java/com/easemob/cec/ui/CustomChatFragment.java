...
import com.easemob.cec.widget.chatrow.ChatRowEvaluation;
import com.easemob.cec.widget.chatrow.ChatRowForm;
import com.easemob.cec.widget.chatrow.ChatRowLocation;
import com.easemob.cec.widget.chatrow.ChatRowOrder;
import com.easemob.cec.widget.chatrow.ChatRowTrack;
...
//        startActivity(new Intent(getActivity(), ...class));
    ...
    @Override
    public  void onMessageItemClick(final Message message, MessageList.ItemAction action)
    {
        if (action == MessageList.ItemAction.ITEM_TO_NOTE) {
            Intent intent = new Intent(getActivity(), NewLeaveMessageActivity.class);
            startActivity(intent);
        } else if (action == MessageList.ItemAction.ITEM_RESOLVED) {
            ChatManager.getInstance().postRobotQuality(message, true, null, new EMCallBack() {
                @Override
                public void onSuccess() {
                    EMLog.d(ChatFragment.TAG, "robot comment sucess");
                ...
                public void onError(int i, String s) {
                    EMLog.e(ChatFragment.TAG, "robot comment fail: " + i + "reason: " + s);
                }
        ...
        } else if (action == MessageList.ItemAction.ITEM_UNSOLVED) {
...
//                return true;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            } else if (requestCode == ChatFragment.REQUEST_CODE_EVAL) {
                messageList.refresh();
            }
        }
    ...
    private final class DemoCustomChatRowProvider implements CustomChatRowProvider {
        ...
        public int getCustomChatRowType(Message message) {
            ...
            if (message.getType() == Message.Type.LOCATION){
                ...
                if (messageExtType == MessageHelper.ExtMsgType.EvaluationMsg) {
                ...
                } else if (messageExtType == MessageHelper.ExtMsgType.FormMsg) {
